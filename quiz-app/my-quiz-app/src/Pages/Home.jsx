...
function Home() {
 ...
 <div className="home">
        ...
        <div className="logo-section">
          <img  data-testid="home-logo" src="lrnr.png" alt="Logo" className="logo" />
          <h3>Your guided path to programming enlightenment</h3>
          <Link to='/generate'>
          <button data-testid="begin-bttn" className="jrny-button">Begin Journey</button>
          </Link>
        </div>
        ...
        <div className="info-container">
          ...
          <div className="info">
          <span data-testid="flash-logo"className="material-icons">flash_on</span>
...
payments
            ...
            <h3>Rewarding</h3>
            <p className='rewarding-paragraph' data-testid="rewarding">
